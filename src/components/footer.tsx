...
export function Footer() {
  return <footer className="footer"><div className="footer-top">
    ...
    <div><b>Besoin d’aide ?</b><Link href="/resources">Ressources d’écoute</Link><Link href="/safety">Charte & modération</Link><a href={`mailto:${CONTACT_EMAIL}`}>Nous contacter</a></div>
